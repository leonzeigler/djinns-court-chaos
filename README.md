...
no app, no download. Judge Djinn Ra hears the arguments and delivers
...
5. Host locks arguments → **Judge Djinn Ra delivers the verdict**,
...
- `judge.js` — Djinn Ra's verdict engine (template-based now;
